...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.position_lr_init = 0.0025#0.00016 #0.001#
        self.position_lr_final = 0.0000016 #0.0001#0.000001  # SMoE-g: 0.0000001, SMoE-r: 0.000001
        self.position_lr_delay_mult = 0.1
        self.position_lr_max_steps = 30000
        self.feature_lr = 0.0025#0.0025
        self.opacity_lr = 0.05 #0.05
        self.scaling_lr = 0.005 #0.005#0.005
        self.rotation_lr =  0.001#0.0011 #0.01
