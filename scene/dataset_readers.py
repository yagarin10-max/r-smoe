...
def readColmapCameras(cam_extrinsics, cam_intrinsics, images_folder):
    ...
    for idx, key in enumerate(cam_extrinsics):
        ...
        # else:
        #     low_clip = 0.0
        # noise = np.random.default_rng(None).normal(0.0, 0.0037 ** 0.5, image_np.shape)
        # out = image_np + noise
        # out = np.clip(out, low_clip, 1.0)
        # image = Image.fromarray(np.array(out*255., dtype = 'uint8'))
        # noise ============================================================
        # image = skimage.io.imread(image_path)
        # var = np.random.rand(1) * 0.005
        # print(var)
        # #var = 0
        # image = skimage.util.random_noise(image, mode='gaussian',var=var)
        ...
        # image = Image.open(image_path)
        # imw, imh = image.size
        # image = image.resize((int(imw/8), int(imh/8)))
        # width /= 8
        # height /= 8
        # print(image.getextrema(), image_path)
        # end SR =========================================================
